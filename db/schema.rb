...
ActiveRecord::Schema.define(:version => 20130615090521) do
  ...
  add_index "refinery_event_translations", ["refinery_event_id"], :name => "index_refinery_event_translations_on_refinery_event_id"
  ...
  create_table "refinery_events_type_translations", :force => true do |t|
    t.integer  "refinery_events_type_id"
    t.string   "locale"
    t.string   "name"
    t.datetime "created_at",              :null => false
    t.datetime "updated_at",              :null => false
  ...
  add_index "refinery_events_type_translations", ["locale"], :name => "index_refinery_events_type_translations_on_locale"
  add_index "refinery_events_type_translations", ["refinery_events_type_id"], :name => "index_687809fb6873ebc25d4328439741878ef75f6385"

  create_table "refinery_events_types", :force => true do |t|
    t.string   "name"
    t.integer  "position"
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
